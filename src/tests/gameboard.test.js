...
// Tests creating, placing and attacking ships. Passes down the (computer ships object) so hit can change the hit value of whichever one was hit. Need to pass down the values when doing the logic though.
